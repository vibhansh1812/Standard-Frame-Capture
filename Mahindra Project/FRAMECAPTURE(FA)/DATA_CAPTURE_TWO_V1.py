...
class ImageCapture():
        ...
        try:
            ...
            for i, cam in enumerate(cam_list):
                try:
                    ...
                    if device_serial_number in [SIDE4_DEVICE,SIDE6_DEVICE,SIDE7_DEVICE,SIDE10_DEVICE,SIDE12_DEVICE,SIDE14_DEVICE]:
    ...
    def get_dummy_images(self, cam_list, device_list):
        ...
        try:
            ...
            if hour == 6 and minute > 0 and minute < 25:
                ...
                logger.debug(f"Dummy Image Capture is Out of Given Time Period ")
                    ...
                    for i, cam in enumerate(cam_list):
                        ...
                        if PySpin.IsAvailable(node_device_serial_number) and PySpin.IsReadable(node_device_serial_number):
                            ...
                            if image_result.IsIncomplete():
                                ...
                                if device_serial_number == SIDE4_DEVICE:
                                ...
                                elif device_serial_number == SIDE6_DEVICE:
                                    ...
                                    logger.debug(f"engine_number is {engine_number} device_serial_number{device_serial_number} image save fileName is : {fileName}")
                                    print("fileName is===================:",fileName)
                                elif device_serial_number == SIDE7_DEVICE:
                                    fileName = f"{SAVE_IMG_FILE_PATH}/IMG_7.jpeg"
                                    img = image_converted.GetNDArray()
                                    cv2.imwrite(fileName, img)     
                                    fileName_list.append(img)  
                                    image_result.Release()
                                ...
                                elif device_serial_number == SIDE10_DEVICE:
                                    ...
                                    logger.debug(f"engine_number is {engine_number} device_serial_number{device_serial_number} image save fileName is : {fileName}")
                                    print("fileName is===================:",fileName)
                                elif device_serial_number == SIDE12_DEVICE:
                                    ...
                                    logger.debug(f"engine_number is {engine_number} device_serial_number{device_serial_number} image save fileName is : {fileName}")
                                    print("fileName is===================:",fileName)
                                # elif device_serial_number == SIDE13_DEVICE:
                                ...
                                #     logger.debug(f"engine_number is {engine_number} device_serial_number{device_serial_number} image save fileName is : {fileName}")
                                #     print("fileName is===================:",fileName)
                                elif device_serial_number == SIDE14_DEVICE:
    ...
    def initCam(self):
        try:
            ...
            self.get_dummy_images(cam_list, device_list)
